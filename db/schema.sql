...
--     DEFAULT 0 and unseeded, which zeroes the risk engine: in
--     src/lib/risk.js `stake = w*safety + (1-w)*revenue`, so with
--     both inputs at 0 every vehicle scores 0 and the ranking
--     collapses. These two columns ARE the product.
...
-- Indexes -----------------------------------------------------
-- Three access patterns: plate lookup on scan, documents-by-vehicle
-- on fleet load, expiry ordering for the naive/expiry ranking mode.
...
-- heavy trucks earn most and carry nobody; buses carry up to 65 at
-- mid revenue; taxis carry 16-22. That spread is what makes the
-- revenue-vs-safety trade-off visible instead of theoretical.

INSERT INTO vehicles
    (plate_number, vehicle_name, vehicle_type, vin, driver_name, daily_revenue, passenger_load)
VALUES
('DK 84 PT GP', 'Isuzu FX-Series 26-360 6x4 Freight Carrier',   'Heavy Goods Vehicle (Truck)',  'JALFX360M00184920', 'S. Ndlovu',    4200, 0),
('CAA 812-394', 'Mercedes-Benz Actros 2645 LS 6x4',             'Heavy Goods Vehicle (Truck)',  'WDB9634031L839201', 'M. Petersen',  5100, 0),
('FT 39 LW GP', 'Volvo FH 440 6x4 Tractor',                     'Heavy Goods Vehicle (Truck)',  'YV2AG30C7LB921048', 'T. Abrahams',  4800, 0),
('CA 948-201',  'Hino 500 Series 1627 Freight',                 'Heavy Goods Vehicle (Truck)',  'AHF1627M009483019', 'L. Daniels',   3600, 0),
('HG 19 TR GP', 'MAN TGS 27.480 6x4 BL SA',                     'Heavy Goods Vehicle (Truck)',  'WMA23XZZ5KW094812', 'R. Isaacs',    4500, 0),
('CAA 401-928', 'Scania G460 Streamline 6x4',                   'Heavy Goods Vehicle (Truck)',  'YS2G6X40002938102', 'D. van Wyk',   5300, 0),
('JN 42 BK GP', 'UD Trucks Croner PKE 250',                     'Heavy Goods Vehicle (Truck)',  'NCVPKE25000392810', 'N. Fortuin',   3400, 0),
('CA 593-102',  'Fuso FJ 16-230 Rigid',                         'Heavy Goods Vehicle (Truck)',  'ME8FJ16230K093821', 'P. Mokoena',   3900, 0),
('KC 61 PR GP', 'Toyota HiAce 2.5 D-4D Panel Van',              'Courier Van (LCV)',            'AHTK22P0009284019', 'B. Nel',       2100, 0),
('CAA 672-109', 'Mercedes-Benz Sprinter 314 CDI Panel Van',     'Courier Van (LCV)',            'W1V9076331N849201', 'K. Adams',     2400, 0),
('LV 88 XM GP', 'Ford Transit 2.2 TDCi L2H2 Panel Van',         'Courier Van (LCV)',            'WF0XXXTTFXKP83920', 'J. Sithole',   2200, 0),
('CA 391-721',  'Volkswagen Transporter 2.0 TDI Panel Van',     'Courier Van (LCV)',            'WV1ZZZ7JZPH039281', 'A. Booysen',   1900, 0),
('MX 29 BZ GP', 'Hyundai H100 2.6D Bakkie with Canopy',         'Courier Van (LCV)',            'KMJFD17HPMA839201', 'C. Maree',     1600, 1),
('CAA 204-819', 'Nissan NV350 2.5 Impendulo Panel Van',         'Courier Van (LCV)',            'ADNFAAE15U0092841', 'F. Jacobs',    2000, 0),
('NP 55 TR GP', 'Peugeot Boxer 2.2 HDi Panel Van',              'Courier Van (LCV)',            'VF3Y3MCMFC1092840', 'G. Khoza',     2300, 0),
('CA 910-482',  'Renault Master 2.3 dCi Panel Van',             'Courier Van (LCV)',            'VF1MA000062948102', 'H. Barends',   2500, 0),
('PJ 77 DC GP', 'Toyota Quantum 2.7 Ses''fikile 16-Seater',     'Midibus Taxi',                 'AHTE12P3009281049', 'B. Khumalo',   1800, 16),
('CAA 519-302', 'Toyota Quantum 2.5 D-4D 16-Seater',            'Midibus Taxi',                 'AHTK12P0008392019', 'S. Dlamini',   1750, 16),
('RK 12 MK GP', 'Mercedes-Benz Sprinter 516 CDI 22-Seater',     'Midibus Taxi',                 'W1V9066551N039281', 'M. Radebe',    2000, 22),
('CA 702-811',  'Nissan NV350 Impendulo 16-Seater',             'Midibus Taxi',                 'ADNFAAE15U0109284', 'T. Nkosi',     1700, 16),
('ST 33 NW GP', 'Iveco Daily 50C15 22-Seater Midibus',          'Midibus Taxi',                 'ZCFC50A1005928102', 'W. Mahlangu',  1950, 22),
('CAA 941-023', 'Toyota Coaster 2.8D 21-Seater',                'Midibus Taxi',                 'JTEDR73T000928104', 'E. Molefe',    1900, 21),
('VB 90 HY GP', 'Volkswagen Crafter 50 22-Seater',              'Midibus Taxi',                 'WV1ZZZ2EZH7039281', 'Z. Ngcobo',    2050, 22),
('CA 831-502',  'Isipho Hino 300 614 22-Seater',                'Midibus Taxi',                 'AHF300M0009382019', 'V. Cele',      1850, 22),
('WY 41 KL GP', 'Mercedes-Benz OF 1723 60-Seater Commuter Bus', 'Heavy Passenger Vehicle (Bus)','9BM384039L0928410', 'O. Mabaso',    3200, 60),
('CAA 102-948', 'MAN RR2 19.360 Marcopolo Torino',              'Heavy Passenger Vehicle (Bus)','WMA19XZZ3MW039281', 'I. Pietersen', 3400, 55),
('XZ 10 MM GP', 'Scania K360IB 4x2 Marcopolo G7',               'Heavy Passenger Vehicle (Bus)','YS2K4X20003928102', 'Q. Zwane',     3600, 58),
('CA 449-102',  'Volvo B8R 4x2 Busmark 65-Seater',              'Heavy Passenger Vehicle (Bus)','YV3R8R201KB092841', 'L. Mthembu',   3800, 65),
('YB 82 PT GP', 'Isuzu NQR 500 Busmark 35-Seater',              'Heavy Passenger Vehicle (Bus)','JALNQR500M0039281', 'U. Baloyi',    2400, 35),
('CAA 339-182', 'Mercedes-Benz O 500 M 1830 City Bus',          'Heavy Passenger Vehicle (Bus)','9BM384102N0938201', 'Y. Nkomo',     3100, 62),
('ZC 99 BR GP', 'Scania K410EB 6x2*4 Irizar i6',                'Heavy Passenger Vehicle (Bus)','YS2K6X20008392018', 'X. Mnguni',    4100, 49),
('CA 192-803',  'MAN Lion''s Explorer 18.280',                  'Heavy Passenger Vehicle (Bus)','WMA18XZZ2KW092841', 'R. Sibiya',    3500, 51);
